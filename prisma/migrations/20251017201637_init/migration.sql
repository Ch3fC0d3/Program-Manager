...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('BACKLOG', 'NEXT_7_DAYS', 'IN_PROGRESS', 'BLOCKED', 'DONE');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'COMMENT_MENTION', 'DUE_DATE_REMINDER', 'DEPENDENCY_BLOCKED', 'TASK_COMPLETED');
...
-- CreateIndex
CREATE INDEX "Reminder_time_sent_idx" ON "Reminder"("time", "sent");
