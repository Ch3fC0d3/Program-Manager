...
**Subject:** Welcome to [Your Company] Program Manager - Let's Get Started! 🚀

---

Hi [User Name],

Welcome to the team! We're excited to have you on board. Your account has been created and you're all set to start using our Program Manager platform.

## 🔐 Your Login Details

**Email:** [user@email.com]  
**Temporary Password:** [provided by admin]  
**Login URL:** [your-app-url.com/login]

**Important:** Please change your password after your first login by visiting Settings > Security.
...
When you first log in, you'll see interactive tours on each page. These will walk you through:
...
Our platform includes powerful AI tools to boost your productivity:

- **🤖 AI Drop Zone** (Dashboard) - Drop any file and let AI extract tasks, contacts, or data
- **💬 AI Task Assistant** (Blue chat button, bottom right) - Ask questions like:
...
| **Message Board** | Team announcements and updates |

---

## 🆘 Need Help?

- **🐛 Report a Bug** - Click the red bug button (bottom right) to report issues
- **💬 AI Assistant** - Ask the AI Task Assistant for instant help
- **👤 Contact Your Manager** - Reach out to [Manager Name] at [manager@email.com]
- **📖 Documentation** - Visit [docs-url] for detailed guides
...
Log in now and take your first tour! If you have any questions, don't hesitate to reach out.

**[Login to Program Manager →]**
